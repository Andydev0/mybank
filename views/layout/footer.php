    ...
    <footer class="rodape">
        <section class="rodape-autor">
            <p class="rodape-autor-nome">
                Anderson Silva - Direitos Reservados &reg;
            </p>
        </section>
        <section class="rodape-contato">
            ...
            <a href="#" class="rodape-contato-link">
                ...
                <span class="rodape-icone-legenda">Linkedin</span>
            </a>
            <a href="#" class="rodape-contato-link">
    ...
    <div class="chat-whatsapp">
        <button class="zap" onclick="window.location.href='https://api.whatsapp.com/send?phone=SEUNUMERODOTELEFONE'">
            WhatsApp
